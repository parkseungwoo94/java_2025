...
public class Casting002 {
	public static void main(String[] args) {
		...
		System.out.println("Q1-1 :" + 'a' + "\t" + (int)'A'  );   //65
		System.out.println("Q1-2 :" + 'a' + "\t" + (int)'a'  );	  //97
		// a = A+32
		System.out.println( (char)('A'+32) );     //char : 2byte + int : 4byte
		...
		char ch = scanner.next().charAt(0);
		       // scanner.next() 문자열입력 / charAt(0) 첫번재 문자
		System.out.println("입력한 문자 : " + ch);
		
		
		
		//Q2. 대문자 입력받아서 소문자로 변경프로그램 - 클래스명 : CastingEx003.java
