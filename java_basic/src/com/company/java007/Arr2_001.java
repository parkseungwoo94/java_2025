...
public class Arr2_001 {
	public static void main(String[] args) {
		...
		//ver-2 칸정리
		for (int kan=0; kan<3; kan++){System.out.print(arr[0][kan]+"\t");}    // 15번재 줄 줄이기
		System.out.println();
		
		for (int kan=0; kan<3; kan++){System.out.print(arr[1][kan]+"\t");}    // 18번재 줄 줄이기
		System.out.println();
		
		//ver-3 층 정리
	for(int ch=0; ch<2; ch++){
		for (int kan=0; kan<3; kan++){System.out.print(arr[ch][kan]+"\t");}    // 18번재 줄 줄이기
		System.out.println();
	}	//이중 for 완성!
